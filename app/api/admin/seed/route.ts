    ...
    if (eventsCount === 0) {
      await prisma.event.createMany({
        data: [
          ...
          { date: "22", dayOfWeek: "Sunday", month: "March", year: 2026, title: "Painting Tutorial: Citadel Contrast Paints", time: "2:00 PM – 5:00 PM", category: "WORKSHOP", description: "Master the art of Contrast paints with our in-house painter. Perfect for beginners and veterans.", icon: "🎨", price: "$15", capacity: 10, displayOrder: 1 },
          { date: "27", dayOfWeek: "Friday", month: "March", year: 2026, title: "Friday Night Magic — Modern Format", time: "7:00 PM – 11:00 PM", category: "TOURNAMENT", description: "Weekly FNM tournament running Modern format. Entry fee includes prize store credit.", icon: "🃏", price: "$5 Entry", capacity: 16, displayOrder: 2 },
          { date: "28", dayOfWeek: "Saturday", month: "March", year: 2026, title: "D&D One-Shot: The Sunken Tavern", time: "1:00 PM – 6:00 PM", category: "CAMPAIGN", description: "A self-contained one-shot adventure for 4–6 players. Pre-generated characters provided.", icon: "⚔️", price: "$20", capacity: 6, displayOrder: 3 },
          ...
          { date: "5", dayOfWeek: "Sunday", month: "April", year: 2026, title: "Pint Night: Local Brewery Tap Takeover", time: "5:00 PM – 10:00 PM", category: "PINT NIGHT", description: "Misty Mountain Brewery takes over our 6 guest taps for one legendary night.", icon: "🍺", price: "Pay per pint", displayOrder: 5 },
